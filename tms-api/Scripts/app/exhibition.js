...
//var url = "http://localhost/tms-api/exhibitions/{some exhibition id}" + "?token=";
var url = "../Scripts/clients/exhibition_10628.json";

var nodes = [];

d3.json(url, function (json) {

    var nodeParent = { name: json.exhibitionTitle };
